package com.fabiokusaba.listatelefonica.database
...
import com.fabiokusaba.listatelefonica.model.UserModel

class DBHelper(context: Context): SQLiteOpenHelper(context, "dabatase.db", null, 1) {
    ...
    val sql = arrayOf(
        ...
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('Maria', 'Rua das Magnolias', 'maria@email.com', 991128654, -1)",
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('João', 'Rua das Pedras', 'joao@email.com', 981721654, -1)",
    )
